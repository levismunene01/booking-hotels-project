  ...
  const posts = [
    {
      ...
      pricePerNight: 250, // Price per night in dollars
        ...
        {posts.map((post) => (
          <div className="post" key={post.id}>
            ...
            <div className='post__content'>
              ...
              <p>{post.desc}</p>
              <p><strong>Price per night:</strong> ${post.pricePerNight}</p>
              <div className="rating">
                <p><strong>Rating:</strong> {post.rating} <FontAwesomeIcon icon={faStar} className="star-icon" /></p>
              </div>
